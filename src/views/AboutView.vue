...
import SideLayout from "@/components/layouts/side-layout.vue";
</script>
<template>
  <main class="relative w-full h-[calc(100%_-_83.64px)] flex">
    <side-layout class-name="flex">
      <div
        class="p-6 border-2 w-[56px] items-center border-r border-border flex h-full flex-col justify-start gap-6"
      >
        <router-link to="/about/professional">
          <i>
            <svg
      ...
      <div class="w-full flex">Hello word</div>
    </side-layout>
    <section
      class="flex flex-col md:w-[calc(100%_-_220px)] min-[1100px]:w-[calc(100%_-_270px)] h-full relative"
    >
