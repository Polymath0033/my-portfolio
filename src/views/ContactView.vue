...
<template>
  <div class="flex w-full h-[calc(100%_-_81px)]">
    <sideLayout>
      <button
        class="border-b border-border w-full text-base font-light flex gap-1 items-center px-3 py-1"
      >
        <i class="w-4 h-[14px] flex items-center">
          <svg
      ...
      <ul class="text-[#607B96] font-light flex flex-col border-b border-border py-4">
        <li class="px-3 py-1 flex items-center gap-1">
          <i class="w-4 h-[14px]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="17"
          ...
          <a href="mailto:olosanyusuf19@gmail.com" class="text-base"
            >olosanyusuf19</a
          >
        </li>
        <li class="px-3 py-1 flex items-center">
          <i class="w-4 h-[14px]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="17"
            ...
            >
              ...
              /></svg
          ></i>
          <a href="tel:08142206715">+2348142206715</a>
        </li>
      </ul>
        <button
        class="border-b border-border w-full text-base font-light flex gap-1 items-center px-3 py-1"
      ...
      <ul class="flex flex-col gap-2 py-4">
        ...
        <li class="px-3 py-1 flex items-center" ><i class="w-4 h-4" >
    ...
    <div class="h-full">Hello from contact</div>
  </div>
</template>
